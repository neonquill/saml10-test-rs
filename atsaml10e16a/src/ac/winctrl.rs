...
pub type WEN0_W<'a> = crate::BitWriter<'a, u8, WINCTRL_SPEC, bool, 0>;
...
pub type WINTSEL0_R = crate::FieldReader<u8, WINTSEL0_A>;
impl WINTSEL0_R {
...
pub type WINTSEL0_W<'a> =
    crate::FieldWriterSafe<'a, u8, WINCTRL_SPEC, u8, WINTSEL0_A, 2, 1>;
impl<'a> WINTSEL0_W<'a> {
...
impl R {
    ...
    pub fn wintsel0(&self) -> WINTSEL0_R {
        WINTSEL0_R::new(((self.bits >> 1) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Window 0 Mode Enable"]
