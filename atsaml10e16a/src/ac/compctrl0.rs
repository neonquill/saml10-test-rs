#[doc = "Register `COMPCTRL0` reader"]
pub struct R(crate::R<COMPCTRL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COMPCTRL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COMPCTRL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COMPCTRL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `COMPCTRL0` writer"]
pub struct W(crate::W<COMPCTRL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<COMPCTRL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<COMPCTRL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<COMPCTRL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_W<'a> = crate::BitWriter<'a, u32, COMPCTRL0_SPEC, bool, 1>;
#[doc = "Field `SINGLE` reader - Single-Shot Mode"]
pub type SINGLE_R = crate::BitReader<bool>;
#[doc = "Field `SINGLE` writer - Single-Shot Mode"]
pub type SINGLE_W<'a> = crate::BitWriter<'a, u32, COMPCTRL0_SPEC, bool, 2>;
...
pub type INTSEL_W<'a> =
    crate::FieldWriterSafe<'a, u32, COMPCTRL0_SPEC, u8, INTSEL_A, 2, 3>;
impl<'a> INTSEL_W<'a> {
...
pub type RUNSTDBY_W<'a> = crate::BitWriter<'a, u32, COMPCTRL0_SPEC, bool, 6>;
...
pub type MUXNEG_W<'a> =
    crate::FieldWriterSafe<'a, u32, COMPCTRL0_SPEC, u8, MUXNEG_A, 3, 8>;
impl<'a> MUXNEG_W<'a> {
    #[doc = "I/O pin 0"]
    #[inline(always)]
...
pub type MUXPOS_W<'a> =
    crate::FieldWriter<'a, u32, COMPCTRL0_SPEC, u8, MUXPOS_A, 3, 12>;
impl<'a> MUXPOS_W<'a> {
    #[doc = "I/O pin 0"]
    #[inline(always)]
    pub fn pin0(self) -> &'a mut W {
...
pub type SWAP_W<'a> = crate::BitWriter<'a, u32, COMPCTRL0_SPEC, bool, 15>;
#[doc = "Speed Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum SPEED_A {
...
pub type SPEED_W<'a> =
    crate::FieldWriterSafe<'a, u32, COMPCTRL0_SPEC, u8, SPEED_A, 2, 16>;
impl<'a> SPEED_W<'a> {
    #[doc = "Low speed"]
    #[inline(always)]
...
pub type HYSTEN_W<'a> = crate::BitWriter<'a, u32, COMPCTRL0_SPEC, bool, 19>;
...
pub type HYST_W<'a> =
    crate::FieldWriterSafe<'a, u32, COMPCTRL0_SPEC, u8, HYST_A, 2, 20>;
impl<'a> HYST_W<'a> {
    #[doc = "50mV"]
    #[inline(always)]
...
pub type FLEN_W<'a> =
    crate::FieldWriter<'a, u32, COMPCTRL0_SPEC, u8, FLEN_A, 3, 24>;
impl<'a> FLEN_W<'a> {
    #[doc = "No filtering"]
    #[inline(always)]
...
pub type OUT_W<'a> =
    crate::FieldWriter<'a, u32, COMPCTRL0_SPEC, u8, OUT_A, 2, 28>;
impl<'a> OUT_W<'a> {
...
#[doc = "Comparator Control 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [compctrl0](index.html) module"]
pub struct COMPCTRL0_SPEC;
impl crate::RegisterSpec for COMPCTRL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [compctrl0::R](R) reader structure"]
impl crate::Readable for COMPCTRL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [compctrl0::W](W) writer structure"]
impl crate::Writable for COMPCTRL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets COMPCTRL0 to value 0"]
impl crate::Resettable for COMPCTRL0_SPEC {
    #[inline(always)]
