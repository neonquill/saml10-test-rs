...
pub type PRI_W<'a> = crate::FieldWriter<'a, u8, PRICTRL_SPEC, u8, u8, 2, 0>;
...
pub type RREN_W<'a> = crate::BitWriter<'a, u8, PRICTRL_SPEC, bool, 7>;
impl R {
    #[doc = "Bits 0:1 - Channel Priority Number"]
    #[inline(always)]
    pub fn pri(&self) -> PRI_R {
        PRI_R::new((self.bits & 3) as u8)
    }
