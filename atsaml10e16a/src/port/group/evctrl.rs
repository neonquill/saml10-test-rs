...
pub type PID0_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 5, 0>;
...
pub type EVACT0_R = crate::FieldReader<u8, EVACT0_A>;
impl EVACT0_R {
...
pub type EVACT0_W<'a> =
    crate::FieldWriterSafe<'a, u32, EVCTRL_SPEC, u8, EVACT0_A, 2, 5>;
impl<'a> EVACT0_W<'a> {
...
pub type PORTEI0_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 7>;
...
pub type PID1_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 5, 8>;
...
pub type EVACT1_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 2, 13>;
...
pub type PORTEI1_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 15>;
...
pub type PID2_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 5, 16>;
...
pub type EVACT2_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 2, 21>;
...
pub type PORTEI2_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 23>;
...
pub type PID3_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 5, 24>;
...
pub type EVACT3_W<'a> = crate::FieldWriter<'a, u32, EVCTRL_SPEC, u8, u8, 2, 29>;
...
pub type PORTEI3_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 31>;
impl R {
