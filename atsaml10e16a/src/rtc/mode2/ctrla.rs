...
pub type CLKREP_R = crate::BitReader<bool>;
#[doc = "Field `CLKREP` writer - Clock Representation"]
pub type CLKREP_W<'a> = crate::BitWriter<'a, u16, CTRLA_SPEC, bool, 6>;
...
pub type CLOCKSYNC_W<'a> = crate::BitWriter<'a, u16, CTRLA_SPEC, bool, 15>;
impl R {
