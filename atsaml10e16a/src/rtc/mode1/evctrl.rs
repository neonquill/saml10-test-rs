...
pub type PEREO0_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 0>;
...
pub type PEREO1_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 1>;
...
pub type PEREO2_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 2>;
...
pub type PEREO3_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 3>;
...
pub type PEREO4_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 4>;
...
pub type PEREO5_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 5>;
...
pub type PEREO6_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 6>;
...
pub type PEREO7_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 7>;
...
pub type CMPEO0_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 8>;
#[doc = "Field `CMPEO1` reader - Compare 1 Event Output Enable"]
pub type CMPEO1_R = crate::BitReader<bool>;
#[doc = "Field `CMPEO1` writer - Compare 1 Event Output Enable"]
pub type CMPEO1_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 9>;
#[doc = "Field `TAMPEREO` reader - Tamper Event Output Enable"]
pub type TAMPEREO_R = crate::BitReader<bool>;
#[doc = "Field `TAMPEREO` writer - Tamper Event Output Enable"]
pub type TAMPEREO_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 14>;
...
pub type OVFEO_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 15>;
#[doc = "Field `TAMPEVEI` reader - Tamper Event Input Enable"]
pub type TAMPEVEI_R = crate::BitReader<bool>;
#[doc = "Field `TAMPEVEI` writer - Tamper Event Input Enable"]
pub type TAMPEVEI_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 16>;
#[doc = "Field `PERDEO` reader - Periodic Interval Daily Event Output Enable"]
pub type PERDEO_R = crate::BitReader<bool>;
#[doc = "Field `PERDEO` writer - Periodic Interval Daily Event Output Enable"]
pub type PERDEO_W<'a> = crate::BitWriter<'a, u32, EVCTRL_SPEC, bool, 24>;
impl R {
    ...
    #[doc = "Bit 24 - Periodic Interval Daily Event Output Enable"]
    #[inline(always)]
    pub fn perdeo(&self) -> PERDEO_R {
        PERDEO_R::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Periodic Interval 0 Event Output Enable"]
    ...
    #[doc = "Bit 24 - Periodic Interval Daily Event Output Enable"]
    #[inline(always)]
    pub fn perdeo(&mut self) -> PERDEO_W {
        PERDEO_W::new(self)
    }
