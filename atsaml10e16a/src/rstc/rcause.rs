...
#[doc = "Field `BOD12` reader - Brown Out 1.2V Detector Reset"]
pub type BOD12_R = crate::BitReader<bool>;
#[doc = "Field `BOD33` reader - Brown Out 3.3V Detector Reset"]
...
impl R {
    ...
    #[doc = "Bit 1 - Brown Out 1.2V Detector Reset"]
    #[inline(always)]
    pub fn bod12(&self) -> BOD12_R {
        BOD12_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Brown Out 3.3V Detector Reset"]
    #[inline(always)]
