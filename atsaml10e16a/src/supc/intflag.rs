...
pub type BOD33RDY_W<'a> = crate::BitWriter<'a, u32, INTFLAG_SPEC, bool, 0>;
...
pub type BOD33DET_W<'a> = crate::BitWriter<'a, u32, INTFLAG_SPEC, bool, 1>;
...
pub type B33SRDY_W<'a> = crate::BitWriter<'a, u32, INTFLAG_SPEC, bool, 2>;
...
pub type VREGRDY_W<'a> = crate::BitWriter<'a, u32, INTFLAG_SPEC, bool, 8>;
#[doc = "Field `VCORERDY` reader - VDDCORE Ready"]
pub type VCORERDY_R = crate::BitReader<bool>;
#[doc = "Field `VCORERDY` writer - VDDCORE Ready"]
pub type VCORERDY_W<'a> = crate::BitWriter<'a, u32, INTFLAG_SPEC, bool, 10>;
...
pub type ULPVREFRDY_W<'a> = crate::BitWriter<'a, u32, INTFLAG_SPEC, bool, 11>;
impl R {
