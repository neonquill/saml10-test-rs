...
pub type REFNUM_W<'a> = crate::FieldWriter<'a, u16, CFGA_SPEC, u8, u8, 8, 0>;
#[doc = "Field `DIVREF` reader - Divide Reference Clock"]
pub type DIVREF_R = crate::BitReader<bool>;
#[doc = "Field `DIVREF` writer - Divide Reference Clock"]
pub type DIVREF_W<'a> = crate::BitWriter<'a, u16, CFGA_SPEC, bool, 15>;
impl R {
