...
pub type SWRST_W<'a> = crate::BitWriter<'a, u8, CTRL_SPEC, bool, 0>;
#[doc = "Field `CRC` writer - 32-bit Cyclic Redundancy Code"]
pub type CRC_W<'a> = crate::BitWriter<'a, u8, CTRL_SPEC, bool, 2>;
#[doc = "Field `MBIST` writer - Memory built-in self-test"]
pub type MBIST_W<'a> = crate::BitWriter<'a, u8, CTRL_SPEC, bool, 3>;
impl W {
