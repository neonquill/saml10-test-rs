...
pub struct RegisterBlock {
    _reserved_0_mode0: [u8; 0x70],
}
impl RegisterBlock {
    #[doc = "0x00..0x70 - Clock/Calendar with Alarm"]
    #[inline(always)]
    pub fn mode2(&self) -> &MODE2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const MODE2)
        }
    }
    #[doc = "0x00..0x70 - 16-bit Counter with Two 16-bit Compares"]
    #[inline(always)]
    pub fn mode1(&self) -> &MODE1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const MODE1)
        }
    }
    #[doc = "0x00..0x70 - 32-bit Counter with Single 32-bit Compare"]
    #[inline(always)]
    pub fn mode0(&self) -> &MODE0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const MODE0)
        }
    }
}
#[doc = r"Register block"]
...
pub struct MODE0 {
    ...
    pub gp: [crate::Reg<self::mode0::gp::GP_SPEC>; 2],
    _reserved12: [u8; 0x18],
    ...
    pub tampctrlb: crate::Reg<self::mode0::tampctrlb::TAMPCTRLB_SPEC>,
}
#[doc = r"Register block"]
...
pub struct MODE1 {
    ...
    _reserved12: [u8; 0x1c],
    #[doc = "0x40..0x48 - General Purpose"]
    pub gp: [crate::Reg<self::mode1::gp::GP_SPEC>; 2],
    _reserved13: [u8; 0x18],
    #[doc = "0x60 - Tamper Control"]
    ...
    #[doc = "0x6c - Tamper Control B"]
    pub tampctrlb: crate::Reg<self::mode1::tampctrlb::TAMPCTRLB_SPEC>,
}
#[doc = r"Register block"]
...
pub struct MODE2 {
    ...
    _reserved12: [u8; 0x1b],
    #[doc = "0x40..0x48 - General Purpose"]
    pub gp: [crate::Reg<self::mode2::gp::GP_SPEC>; 2],
    _reserved13: [u8; 0x18],
    #[doc = "0x60 - Tamper Control"]
    ...
    #[doc = "0x6c - Tamper Control B"]
    pub tampctrlb: crate::Reg<self::mode2::tampctrlb::TAMPCTRLB_SPEC>,
}
#[doc = r"Register block"]
