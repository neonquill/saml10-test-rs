...
pub type PERBUF_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PERBUF` writer - Period Buffer Value"]
pub type PERBUF_W<'a> =
    crate::FieldWriter<'a, u16, PERBUF_SPEC, u16, u16, 16, 0>;
impl R {
...
#[doc = "`reset()` method sets PERBUF to value 0xffff"]
