...
pub type WAVEGEN_R = crate::FieldReader<u8, WAVEGEN_A>;
impl WAVEGEN_R {
...
pub type WAVEGEN_W<'a> =
    crate::FieldWriterSafe<'a, u8, WAVE_SPEC, u8, WAVEGEN_A, 2, 0>;
impl<'a> WAVEGEN_W<'a> {
...
impl R {
    ...
    pub fn wavegen(&self) -> WAVEGEN_R {
        WAVEGEN_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Waveform Generation Mode"]
