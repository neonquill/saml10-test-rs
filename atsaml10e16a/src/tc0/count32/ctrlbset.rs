...
pub type DIR_W<'a> = crate::BitWriter<'a, u8, CTRLBSET_SPEC, bool, 0>;
#[doc = "Field `LUPD` reader - Lock Update"]
pub type LUPD_R = crate::BitReader<bool>;
#[doc = "Field `LUPD` writer - Lock Update"]
pub type LUPD_W<'a> = crate::BitWriter<'a, u8, CTRLBSET_SPEC, bool, 1>;
...
pub type ONESHOT_W<'a> = crate::BitWriter<'a, u8, CTRLBSET_SPEC, bool, 2>;
#[doc = "Command\n\nValue on reset: 0"]
...
pub type CMD_W<'a> = crate::FieldWriter<'a, u8, CTRLBSET_SPEC, u8, CMD_A, 3, 5>;
impl<'a> CMD_W<'a> {
    #[doc = "No action"]
    #[inline(always)]
