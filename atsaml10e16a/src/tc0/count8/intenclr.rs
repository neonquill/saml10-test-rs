...
pub type MC0_W<'a> = crate::BitWriter<'a, u8, INTENCLR_SPEC, bool, 4>;
...
pub type MC1_W<'a> = crate::BitWriter<'a, u8, INTENCLR_SPEC, bool, 5>;
impl R {
