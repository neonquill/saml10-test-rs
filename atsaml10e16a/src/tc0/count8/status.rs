...
pub type PERBUFV_W<'a> = crate::BitWriter<'a, u8, STATUS_SPEC, bool, 3>;
...
pub type CCBUFV0_W<'a> = crate::BitWriter<'a, u8, STATUS_SPEC, bool, 4>;
...
pub type CCBUFV1_W<'a> = crate::BitWriter<'a, u8, STATUS_SPEC, bool, 5>;
impl R {
