...
pub type BAUD_W<'a> = crate::FieldWriter<'a, u32, BAUD_SPEC, u8, u8, 8, 0>;
...
pub type BAUDLOW_W<'a> = crate::FieldWriter<'a, u32, BAUD_SPEC, u8, u8, 8, 8>;
...
pub type HSBAUD_W<'a> = crate::FieldWriter<'a, u32, BAUD_SPEC, u8, u8, 8, 16>;
...
pub type HSBAUDLOW_W<'a> =
    crate::FieldWriter<'a, u32, BAUD_SPEC, u8, u8, 8, 24>;
impl R {
