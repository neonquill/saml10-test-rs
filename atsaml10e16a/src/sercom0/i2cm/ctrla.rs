...
pub type MEXTTOEN_R = crate::BitReader<bool>;
#[doc = "Field `MEXTTOEN` writer - Master SCL Low Extend Timeout"]
pub type MEXTTOEN_W<'a> = crate::BitWriter<'a, u32, CTRLA_SPEC, bool, 22>;
...
pub type INACTOUT_R = crate::FieldReader<u8, INACTOUT_A>;
impl INACTOUT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type INACTOUT_W<'a> =
    crate::FieldWriterSafe<'a, u32, CTRLA_SPEC, u8, INACTOUT_A, 2, 28>;
impl<'a> INACTOUT_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
