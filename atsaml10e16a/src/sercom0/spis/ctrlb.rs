...
pub type PLOADEN_W<'a> = crate::BitWriter<'a, u32, CTRLB_SPEC, bool, 6>;
...
pub type SSDE_W<'a> = crate::BitWriter<'a, u32, CTRLB_SPEC, bool, 9>;
...
pub type MSSEN_W<'a> = crate::BitWriter<'a, u32, CTRLB_SPEC, bool, 13>;
#[doc = "Address Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum AMODE_A {
...
pub type AMODE_R = crate::FieldReader<u8, AMODE_A>;
impl AMODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type AMODE_W<'a> =
    crate::FieldWriter<'a, u32, CTRLB_SPEC, u8, AMODE_A, 2, 14>;
impl<'a> AMODE_W<'a> {
