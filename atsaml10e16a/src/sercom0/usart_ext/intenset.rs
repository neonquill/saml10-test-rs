...
pub type RXS_W<'a> = crate::BitWriter<'a, u8, INTENSET_SPEC, bool, 3>;
...
pub type CTSIC_W<'a> = crate::BitWriter<'a, u8, INTENSET_SPEC, bool, 4>;
...
pub type RXBRK_W<'a> = crate::BitWriter<'a, u8, INTENSET_SPEC, bool, 5>;
