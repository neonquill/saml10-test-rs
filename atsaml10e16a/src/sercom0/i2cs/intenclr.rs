...
pub type PREC_W<'a> = crate::BitWriter<'a, u8, INTENCLR_SPEC, bool, 0>;
...
pub type AMATCH_W<'a> = crate::BitWriter<'a, u8, INTENCLR_SPEC, bool, 1>;
...
pub type DRDY_W<'a> = crate::BitWriter<'a, u8, INTENCLR_SPEC, bool, 2>;
