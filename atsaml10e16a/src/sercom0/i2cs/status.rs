...
pub type COLL_W<'a> = crate::BitWriter<'a, u16, STATUS_SPEC, bool, 1>;
...
pub type DIR_W<'a> = crate::BitWriter<'a, u16, STATUS_SPEC, bool, 3>;
#[doc = "Field `SR` reader - Repeated Start"]
pub type SR_R = crate::BitReader<bool>;
#[doc = "Field `SR` writer - Repeated Start"]
pub type SR_W<'a> = crate::BitWriter<'a, u16, STATUS_SPEC, bool, 4>;
...
pub type HS_W<'a> = crate::BitWriter<'a, u16, STATUS_SPEC, bool, 10>;
impl R {
    #[doc = "Bit 0 - Bus Error"]
    #[inline(always)]
