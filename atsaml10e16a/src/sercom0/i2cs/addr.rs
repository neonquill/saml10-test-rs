...
pub type GENCEN_W<'a> = crate::BitWriter<'a, u32, ADDR_SPEC, bool, 0>;
#[doc = "Field `ADDR` reader - Address Value"]
pub type ADDR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ADDR` writer - Address Value"]
pub type ADDR_W<'a> = crate::FieldWriter<'a, u32, ADDR_SPEC, u16, u16, 10, 1>;
...
pub type ADDRMASK_W<'a> =
    crate::FieldWriter<'a, u32, ADDR_SPEC, u16, u16, 10, 17>;
impl R {
