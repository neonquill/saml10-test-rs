...
pub type PREC_W<'a> = crate::BitWriter<'a, u8, INTFLAG_SPEC, bool, 0>;
...
pub type AMATCH_W<'a> = crate::BitWriter<'a, u8, INTFLAG_SPEC, bool, 1>;
#[doc = "Field `DRDY` reader - Data Interrupt"]
pub type DRDY_R = crate::BitReader<bool>;
#[doc = "Field `DRDY` writer - Data Interrupt"]
pub type DRDY_W<'a> = crate::BitWriter<'a, u8, INTFLAG_SPEC, bool, 2>;
