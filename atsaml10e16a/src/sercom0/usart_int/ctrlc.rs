...
pub type GTIME_W<'a> = crate::FieldWriter<'a, u32, CTRLC_SPEC, u8, u8, 3, 0>;
...
pub type INACK_W<'a> = crate::BitWriter<'a, u32, CTRLC_SPEC, bool, 16>;
...
pub type DSNACK_W<'a> = crate::BitWriter<'a, u32, CTRLC_SPEC, bool, 17>;
...
pub type MAXITER_W<'a> = crate::FieldWriter<'a, u32, CTRLC_SPEC, u8, u8, 3, 20>;
impl R {
