...
pub type CPUDIV_R = crate::FieldReader<u8, CPUDIV_A>;
impl CPUDIV_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CPUDIV_A> {
        match self.bits {
            1 => Some(CPUDIV_A::DIV1),
            2 => Some(CPUDIV_A::DIV2),
            4 => Some(CPUDIV_A::DIV4),
            8 => Some(CPUDIV_A::DIV8),
            16 => Some(CPUDIV_A::DIV16),
            32 => Some(CPUDIV_A::DIV32),
            64 => Some(CPUDIV_A::DIV64),
            128 => Some(CPUDIV_A::DIV128),
            _ => None,
        }
    }
...
pub type CPUDIV_W<'a> =
    crate::FieldWriter<'a, u8, CPUDIV_SPEC, u8, CPUDIV_A, 8, 0>;
impl<'a> CPUDIV_W<'a> {
    #[doc = "Divide by 1"]
    #[inline(always)]
