...
pub type ENABLE_W<'a> = crate::BitWriter<'a, u32, LUTCTRL_SPEC, ENABLE_A, 1>;
impl<'a> ENABLE_W<'a> {
...
pub type FILTSEL_W<'a> =
    crate::FieldWriter<'a, u32, LUTCTRL_SPEC, u8, FILTSEL_A, 2, 4>;
impl<'a> FILTSEL_W<'a> {
    #[doc = "Filter disabled"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
...
pub type EDGESEL_R = crate::BitReader<EDGESEL_A>;
impl EDGESEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type EDGESEL_W<'a> = crate::BitWriter<'a, u32, LUTCTRL_SPEC, EDGESEL_A, 7>;
impl<'a> EDGESEL_W<'a> {
...
pub enum INSEL0_A {
    ...
    SERCOM = 9,
    #[doc = "11: Asynchronous event input source"]
    ASYNCEVENT = 11,
}
...
pub type INSEL0_W<'a> =
    crate::FieldWriter<'a, u32, LUTCTRL_SPEC, u8, INSEL0_A, 4, 8>;
impl<'a> INSEL0_W<'a> {
    #[doc = "Masked input"]
    #[inline(always)]
    ...
    #[doc = "Asynchronous event input source"]
    #[inline(always)]
...
pub type INSEL1_W<'a> =
    crate::FieldWriter<'a, u32, LUTCTRL_SPEC, u8, INSEL1_A, 4, 12>;
impl<'a> INSEL1_W<'a> {
    #[doc = "Masked input"]
    #[inline(always)]
    pub fn mask(self) -> &'a mut W {
...
pub type INSEL2_W<'a> =
    crate::FieldWriter<'a, u32, LUTCTRL_SPEC, u8, INSEL2_A, 4, 16>;
impl<'a> INSEL2_W<'a> {
    #[doc = "Masked input"]
    #[inline(always)]
    pub fn mask(self) -> &'a mut W {
...
pub type INVEI_R = crate::BitReader<INVEI_A>;
impl INVEI_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> INVEI_A {
        match self.bits {
            false => INVEI_A::NORMAL,
            true => INVEI_A::INVERTED,
        }
    }
    ...
    pub fn is_inverted(&self) -> bool {
        *self == INVEI_A::INVERTED
    }
}
#[doc = "Field `INVEI` writer - Inverted Event Input Enable"]
pub type INVEI_W<'a> = crate::BitWriter<'a, u32, LUTCTRL_SPEC, INVEI_A, 20>;
impl<'a> INVEI_W<'a> {
    #[doc = "Incoming event is not inverted"]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(INVEI_A::NORMAL)
    }
    #[doc = "Incoming event is inverted"]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut W {
        self.variant(INVEI_A::INVERTED)
    }
}
...
pub type LUTEI_R = crate::BitReader<LUTEI_A>;
impl LUTEI_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type LUTEI_W<'a> = crate::BitWriter<'a, u32, LUTCTRL_SPEC, LUTEI_A, 21>;
impl<'a> LUTEI_W<'a> {
...
pub type LUTEO_R = crate::BitReader<LUTEO_A>;
impl LUTEO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type LUTEO_W<'a> = crate::BitWriter<'a, u32, LUTCTRL_SPEC, LUTEO_A, 22>;
impl<'a> LUTEO_W<'a> {
...
pub type TRUTH_W<'a> = crate::FieldWriter<'a, u32, LUTCTRL_SPEC, u8, u8, 8, 24>;
impl R {
