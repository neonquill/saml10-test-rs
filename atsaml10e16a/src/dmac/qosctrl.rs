...
pub type WRBQOS_R = crate::FieldReader<u8, WRBQOS_A>;
impl WRBQOS_R {
...
pub type WRBQOS_W<'a> =
    crate::FieldWriterSafe<'a, u8, QOSCTRL_SPEC, u8, WRBQOS_A, 2, 0>;
impl<'a> WRBQOS_W<'a> {
...
pub type FQOS_R = crate::FieldReader<u8, FQOS_A>;
impl FQOS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type FQOS_W<'a> =
    crate::FieldWriterSafe<'a, u8, QOSCTRL_SPEC, u8, FQOS_A, 2, 2>;
impl<'a> FQOS_W<'a> {
    #[doc = "Background (no sensitive operation)"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
...
pub type DQOS_R = crate::FieldReader<u8, DQOS_A>;
impl DQOS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type DQOS_W<'a> =
    crate::FieldWriterSafe<'a, u8, QOSCTRL_SPEC, u8, DQOS_A, 2, 4>;
impl<'a> DQOS_W<'a> {
    #[doc = "Background (no sensitive operation)"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
