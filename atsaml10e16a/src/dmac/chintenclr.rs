...
pub type TERR_W<'a> = crate::BitWriter<'a, u8, CHINTENCLR_SPEC, bool, 0>;
...
pub type TCMPL_W<'a> = crate::BitWriter<'a, u8, CHINTENCLR_SPEC, bool, 1>;
...
pub type SUSP_W<'a> = crate::BitWriter<'a, u8, CHINTENCLR_SPEC, bool, 2>;
impl R {
