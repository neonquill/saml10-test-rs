...
pub struct RegisterBlock {
    ...
    pub nonseca: crate::Reg<nonseca::NONSECA_SPEC>,
    #[doc = "0x58 - Peripheral non-secure status - Bridge B"]
    pub nonsecb: crate::Reg<nonsecb::NONSECB_SPEC>,
    #[doc = "0x5c - Peripheral non-secure status - Bridge C"]
    pub nonsecc: crate::Reg<nonsecc::NONSECC_SPEC>,
}
...
pub mod statusc;
#[doc = "NONSECA register accessor: an alias for `Reg<NONSECA_SPEC>`"]
pub type NONSECA = crate::Reg<nonseca::NONSECA_SPEC>;
#[doc = "Peripheral non-secure status - Bridge A"]
pub mod nonseca;
#[doc = "NONSECB register accessor: an alias for `Reg<NONSECB_SPEC>`"]
pub type NONSECB = crate::Reg<nonsecb::NONSECB_SPEC>;
#[doc = "Peripheral non-secure status - Bridge B"]
pub mod nonsecb;
#[doc = "NONSECC register accessor: an alias for `Reg<NONSECC_SPEC>`"]
