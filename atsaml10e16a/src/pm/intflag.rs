...
#[doc = "Field `PLRDY` reader - Performance Level Ready"]
pub type PLRDY_R = crate::BitReader<bool>;
#[doc = "Field `PLRDY` writer - Performance Level Ready"]
pub type PLRDY_W<'a> = crate::BitWriter<'a, u8, INTFLAG_SPEC, bool, 0>;
impl R {
    #[doc = "Bit 0 - Performance Level Ready"]
    #[inline(always)]
