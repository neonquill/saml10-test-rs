...
impl RegisterBlock {
    ...
    pub fn spim(&self) -> &SPIM {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const SPIM)
        }
    }
    ...
    pub fn spis(&self) -> &SPIS {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const SPIS)
        }
    }
    ...
    pub fn i2cs(&self) -> &I2CS {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const I2CS)
        }
    }
    ...
    pub fn i2cm(&self) -> &I2CM {
        unsafe {
            &*(((self as *const Self) as *const u8).add(0usize) as *const I2CM)
        }
    }
}
#[doc = r"Register block"]
...
impl USART_EXT {
    ...
    ) -> &crate::Reg<self::usart_ext::baud_usartfp_mode::BAUD_USARTFP_MODE_SPEC>
    {
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<
                    self::usart_ext::baud_usartfp_mode::BAUD_USARTFP_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x0c - USART_EXT Baud Rate"]
    ...
    ) -> &crate::Reg<self::usart_ext::baud_fracfp_mode::BAUD_FRACFP_MODE_SPEC>
    {
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<
                    self::usart_ext::baud_fracfp_mode::BAUD_FRACFP_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x0c - USART_EXT Baud Rate"]
    ...
    pub fn baud_frac_mode(
        ...
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<
                    self::usart_ext::baud_frac_mode::BAUD_FRAC_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x0c - USART_EXT Baud Rate"]
...
impl USART_INT {
    ...
    ) -> &crate::Reg<self::usart_int::baud_usartfp_mode::BAUD_USARTFP_MODE_SPEC>
    {
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<
                    self::usart_int::baud_usartfp_mode::BAUD_USARTFP_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x0c - USART_INT Baud Rate"]
    ...
    ) -> &crate::Reg<self::usart_int::baud_fracfp_mode::BAUD_FRACFP_MODE_SPEC>
    {
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<
                    self::usart_int::baud_fracfp_mode::BAUD_FRACFP_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x0c - USART_INT Baud Rate"]
    ...
    pub fn baud_frac_mode(
        ...
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<
                    self::usart_int::baud_frac_mode::BAUD_FRAC_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x0c - USART_INT Baud Rate"]
