...
pub type ENABLE_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 1>;
...
pub type XTALEN_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 2>;
...
pub type EN32K_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 3>;
#[doc = "Field `EN1K` reader - 1kHz Output Enable"]
pub type EN1K_R = crate::BitReader<bool>;
#[doc = "Field `EN1K` writer - 1kHz Output Enable"]
pub type EN1K_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 4>;
#[doc = "Field `RUNSTDBY` reader - Run in Standby"]
pub type RUNSTDBY_R = crate::BitReader<bool>;
#[doc = "Field `RUNSTDBY` writer - Run in Standby"]
pub type RUNSTDBY_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 6>;
...
pub type ONDEMAND_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 7>;
...
impl STARTUP_R {
    ...
    pub fn variant(&self) -> Option<STARTUP_A> {
        match self.bits {
            0 => Some(STARTUP_A::CYCLE2048),
            1 => Some(STARTUP_A::CYCLE4096),
            2 => Some(STARTUP_A::CYCLE16384),
            3 => Some(STARTUP_A::CYCLE32768),
            4 => Some(STARTUP_A::CYCLE65536),
            5 => Some(STARTUP_A::CYCLE131072),
            6 => Some(STARTUP_A::CYCLE262144),
            _ => None,
        }
    }
...
pub type STARTUP_W<'a> =
    crate::FieldWriter<'a, u16, XOSC32K_SPEC, u8, STARTUP_A, 3, 8>;
impl<'a> STARTUP_W<'a> {
    #[doc = "62.5 ms"]
    #[inline(always)]
...
pub type WRTLOCK_W<'a> = crate::BitWriter<'a, u16, XOSC32K_SPEC, bool, 12>;
impl R {
