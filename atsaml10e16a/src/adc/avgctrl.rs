...
pub type SAMPLENUM_R = crate::FieldReader<u8, SAMPLENUM_A>;
impl SAMPLENUM_R {
...
pub type SAMPLENUM_W<'a> =
    crate::FieldWriter<'a, u8, AVGCTRL_SPEC, u8, SAMPLENUM_A, 4, 0>;
...
pub type ADJRES_W<'a> = crate::FieldWriter<'a, u8, AVGCTRL_SPEC, u8, u8, 3, 4>;
impl R {
    ...
    pub fn adjres(&self) -> ADJRES_R {
        ADJRES_R::new(((self.bits >> 4) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Number of Samples to be Collected"]
