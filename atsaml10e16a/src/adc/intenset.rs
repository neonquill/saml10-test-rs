...
pub type RESRDY_W<'a> = crate::BitWriter<'a, u8, INTENSET_SPEC, bool, 0>;
...
pub type OVERRUN_W<'a> = crate::BitWriter<'a, u8, INTENSET_SPEC, bool, 1>;
...
pub type WINMON_W<'a> = crate::BitWriter<'a, u8, INTENSET_SPEC, bool, 2>;
impl R {
