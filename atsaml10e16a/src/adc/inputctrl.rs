...
pub enum MUXPOS_A {
    ...
    BANDGAP = 25,
    #[doc = "26: 1/4 Scaled VDDCORE Supply"]
    SCALEDVDDCORE = 26,
    #[doc = "27: 1/4 Scaled VDDANA Supply"]
    SCALEDVDDANA = 27,
    #[doc = "28: DAC Output"]
    DAC = 28,
    #[doc = "29: 1/4 Scaled VDDIO Supply"]
    SCALEDVDDIO = 29,
...
impl MUXPOS_R {
    ...
    pub fn variant(&self) -> Option<MUXPOS_A> {
        match self.bits {
            ...
            26 => Some(MUXPOS_A::SCALEDVDDCORE),
            27 => Some(MUXPOS_A::SCALEDVDDANA),
            28 => Some(MUXPOS_A::DAC),
            29 => Some(MUXPOS_A::SCALEDVDDIO),
            30 => Some(MUXPOS_A::OPAMP01),
            31 => Some(MUXPOS_A::OPAMP2),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SCALEDVDDCORE`"]
    #[inline(always)]
    pub fn is_scaledvddcore(&self) -> bool {
        *self == MUXPOS_A::SCALEDVDDCORE
    }
    #[doc = "Checks if the value of the field is `SCALEDVDDANA`"]
    #[inline(always)]
    pub fn is_scaledvddana(&self) -> bool {
        *self == MUXPOS_A::SCALEDVDDANA
    }
    ...
    #[doc = "Checks if the value of the field is `SCALEDVDDIO`"]
    #[inline(always)]
    pub fn is_scaledvddio(&self) -> bool {
        *self == MUXPOS_A::SCALEDVDDIO
    }
...
pub type MUXPOS_W<'a> =
    crate::FieldWriter<'a, u16, INPUTCTRL_SPEC, u8, MUXPOS_A, 5, 0>;
impl<'a> MUXPOS_W<'a> {
    #[doc = "ADC AIN0 Pin"]
    #[inline(always)]
    ...
    #[doc = "1/4 Scaled VDDCORE Supply"]
    #[inline(always)]
    pub fn scaledvddcore(self) -> &'a mut W {
        self.variant(MUXPOS_A::SCALEDVDDCORE)
    }
    #[doc = "1/4 Scaled VDDANA Supply"]
    #[inline(always)]
    pub fn scaledvddana(self) -> &'a mut W {
        self.variant(MUXPOS_A::SCALEDVDDANA)
    }
    #[doc = "DAC Output"]
    #[inline(always)]
    ...
    #[doc = "1/4 Scaled VDDIO Supply"]
    #[inline(always)]
    pub fn scaledvddio(self) -> &'a mut W {
        self.variant(MUXPOS_A::SCALEDVDDIO)
    }
...
pub type MUXNEG_W<'a> =
    crate::FieldWriter<'a, u16, INPUTCTRL_SPEC, u8, MUXNEG_A, 5, 8>;
impl<'a> MUXNEG_W<'a> {
    #[doc = "ADC AIN0 Pin"]
    #[inline(always)]
    pub fn ain0(self) -> &'a mut W {
